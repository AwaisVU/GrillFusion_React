...
//Init locaion and receive data sent via state prop
        ...
        <div className="col-md-6">
          ...
          <div className="card border shadow-sm">
            <div className="card-body p-4">
              ...
              <div className="mb-3">
                <strong>Phone Number:</strong> {orderData.pickUpPhone}
              </div>
              ...
              <div className="text-center">
                <button onClick={()=>navigate(MYROUTES.HOME)} className="btn btn-primary">Continue Shopping</button>
              </div>
            </div>
          </div>
        </div>
