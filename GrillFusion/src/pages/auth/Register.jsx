...
export default function Register() {
  ...
  //Controlled component for form data onboard
  ...
  const handleSubmit = async (e) => {
    ...
    //Map form data to the API required fields as per Scalar
    const registerData = {
      name: formData.name,
    ...
    try{
      ...
      if(result.isSuccess){
        ...
        toast.error(result.errorMessages?.[0] || "Something went wrong!")
      }
    }
    catch(error){
        ...
        <div className="row g-5 align-items-center justify-content-center">
          ...
          <div className="col-lg-5 d-none d-lg-block">
            <div className="text-center px-4">
              ...
              <h2 className="fw-bold mb-3">Join Grill Fusion</h2>
          ...
          <div className="col-md-9 col-lg-6 col-xl-5">
            <div className="border rounded-4 shadow-sm p-4 p-lg-5 bg-body-tertiary">
              ...
              <div className="text-center small">
                ...
                <Link to={MYROUTES.LOGIN} className="fw-semibold">
                  Sign in
                </Link>
              </div>
