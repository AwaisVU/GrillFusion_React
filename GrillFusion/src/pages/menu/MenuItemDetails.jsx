...
export default function MenuItemDetails() {
  //We need to fetch the item id dynamically on URL
  const { id } = useParams();
  const itemId = parseInt(id);
  const isValidItemId = !isNaN(itemId) && itemId > 0;
  console.log(id);

  //API call to DB in order to receive details of individual menu item
  const {
  ...
  //State to control quantity for cart
          ...
          <div className="col-lg-6">
            <div className="position-relative">
              <div className="rounded-4 overflow-hidden shadow-lg border bg-body position-relative">
                <img
                  className="img-fluid"
                  src={`${BASE_API_URL}/${selectedMenuItem.image}`}
                  style={{
                    height: "500px",
                    width: "100%",
                    objectFit: "cover",
              ...
              <div className="mb-4">
                <div className="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div className="text-end">
                    <div className="h2 text-primary fw-bold mb-0">${selectedMenuItem.price.toFixed(2)}</div>
                  </div>
                </div>
              </div>
                ...
                <div className="row g-4 text-center">
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="border-end border-light-subtle pe-3">
                      ...
                      <div className="text-primary fw-bold">${selectedMenuItem.price}</div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6">
                    <i
