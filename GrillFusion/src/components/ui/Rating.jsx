...
export default function Rating({
  ...
  const sizeClass =
    size === "small" ? "fs-6" : size === "large" ? "fs-4" : "fs-4";
  ...
  const renderStar = (index) => {
    ...
    return (
      <i
        className={`bi ${isHalf ? "bi-star-half" : isFilled ? "bi-star-fill" : "bi-star"} ${isFilled || isHalf ? "text-warning" : "text-muted"} me-1 ${sizeClass}`}
